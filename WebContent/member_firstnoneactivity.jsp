		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span9">
					...
					<div class="row" id="warningRow" style="display:display">
						<div class="span6">
							<h5 style="padding-left:15px;font-family:微软雅黑">
								<span style="padding-left:8px">很抱歉，您选择的影片暂未制定活动！</span>
							</h5>
						</div>
						<div class="span3">
						</div>
					</div>
					<div class="row" id="q1Row" style="display:none">
						<div class="span6">
							<h5 style="padding-left:15px;font-family:微软雅黑">
								<span>问题1：</span>
								<span style="font-weight:normal" id="question1"></span>
							</h5>
							<ul class="tasks zebra-list" style="padding-left:65px">
								<li>
									<input type="radio" value="1" name="optionsRadio1" checked="checked"/><span id="question1_A" class="title" style="padding-left:5px;font-family:微软雅黑"></span>
								</li>
								<li>
									<input type="radio" value="2" name="optionsRadio1"/><span id="question1_B" class="title" style="padding-left:5px;font-family:微软雅黑"></span>
								</li>
								<li>
									<input type="radio" value="3" name="optionsRadio1"/><span id="question1_C" class="title" style="padding-left:5px;font-family:微软雅黑"></span>
								</li>
							</ul>
						</div>
						<div class="span3">
					...
					<div class="row" id="q2Row" style="display:none">
						<div class="span6">
							<h5 style="padding-left:15px;font-family:微软雅黑">
								<span>问题2：</span>
								<span style="font-weight:normal" id="question2"></span>
							</h5>
							<ul class="tasks zebra-list" style="padding-left:65px">
								<li>
									<input type="radio" value="1" name="optionsRadio2" checked="checked"/><span id="question2_A" class="title" style="padding-left:5px;font-family:微软雅黑"></span>
								</li>
								<li>
									<input type="radio" value="2" name="optionsRadio2"/><span id="question2_B" class="title" style="padding-left:5px;font-family:微软雅黑"></span>
								</li>
								<li>
									<input type="radio" value="3" name="optionsRadio2"/><span id="question2_C" class="title" style="padding-left:5px;font-family:微软雅黑"></span>
								</li>
							</ul>
						</div>
						<div class="span3">
