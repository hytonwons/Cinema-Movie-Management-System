...
function(t) {
    ...
    i.prototype.slide = function(e, o) {
        ...
        if (this.$element.trigger(d), !d.isDefaultPrevented()) {
            ...
            return t.support.transition && this.$element.hasClass("slide") ? (n.addClass(e), n[0].offsetWidth, s.addClass(a), n.addClass(a), s.one("bsTransitionEnd",
            function() {
                ...
                0)
            }).emulateTransitionEnd(i.TRANSITION_DURATION)) : (s.removeClass("active"), n.addClass("active"), this.sliding = !1, this.$element.trigger(f)),
            r && this.cycle(),
            this
        }
    };
...
function(t) {
    ...
    i.prototype.show = function(e) {
        ...
        this.isShown || s.isDefaultPrevented() || (this.isShown = !0, this.checkScrollbar(), this.$body.addClass("modal-open"), this.setScrollbar(), this.escape(), this.$element.on("click.dismiss.bs.modal", '[data-dismiss="modal"]', t.proxy(this.hide, this)), this.backdrop(function() {
...
function(t) {
    ...
    i.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (h) {
                ...
                a = "bottom" == a && p.top + p.height + c - g.scroll > g.height ? "top": "top" == a && p.top - g.scroll - c < 0 ? "bottom": "right" == a && p.right + d > g.width ? "left": "left" == a && p.left - d < g.left ? "right": a,
    ...
    i.prototype.applyPlacement = function(e, i) {
        ...
        var d = p.left ? 2 * p.left - s + l: 2 * p.top - n + h,
        c = p.left ? "left": "top",
    ...
    i.prototype.hide = function() {
        ...
        n.isDefaultPrevented() ? void 0 : (s.removeClass("in"), t.support.transition && this.$tip.hasClass("fade") ? s.one("bsTransitionEnd", e).emulateTransitionEnd(i.TRANSITION_DURATION) : e(), this.hoverState = null, this)
    },
    ...
    i.prototype.getPosition = function(e) {
        ...
        var i = e[0],
        o = "BODY" == i.tagName,
        s = window.SVGElement && i instanceof window.SVGElement,
...
function(t) {
    ...
    function e(e) {
        return this.each(function() {
            ...
            n = t.extend({},
            i.DEFAULTS, o.data(), "object" == typeof e && e); ! s && n.toggle && "show" == e && (n.toggle = !1),
    ...
    i.prototype.hide = function() {
        if (!this.transitioning && this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(e), !e.isDefaultPrevented()) {
                ...
                return t.support.transition ? void this.$element[o](0).one("bsTransitionEnd", t.proxy(s, this)).emulateTransitionEnd(i.TRANSITION_DURATION) : s.call(this)
            }
        }
    },
    i.prototype.toggle = function() {
    ...
    function(i) {
        ...
        p = h && t(h);
        a && a.transitioning || (p && p.find('[data-toggle="collapse"][data-parent="' + h + '"]').not(s).addClass("collapsed"), s.toggleClass("collapsed", r.hasClass("in"))),
        e.call(r, l)
    })
} (jQuery),
+
